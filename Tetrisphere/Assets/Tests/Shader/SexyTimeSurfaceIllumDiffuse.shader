Shader "NAKAI/SexyTimeSurface Illum Diffuse" {
Properties {
...
void main ()
{
  ...
  shlight_1 = tmpvar_9;
  tmpvar_3 = shlight_1;
  gl_Position = (glstate_matrix_mvp * (VertScreenSpace_4 * glstate_matrix_invtrans_modelview0));
...
void main ()
{
  ...
  c_2 = tmpvar_4;
  lowp vec4 c_5;
  c_5.xyz = ((c_2.xyz * _LightColor0.xyz) * (max (0.0, dot (xlv_TEXCOORD1, _WorldSpaceLightPos0.xyz)) * 2.0));
  c_5.w = c_2.w;
  c_1.w = c_5.w;
  c_1.xyz = (c_5.xyz + (c_2.xyz * xlv_TEXCOORD2));
  c_1.xyz = (c_1.xyz + (c_2.xyz * tmpvar_3.w));
  gl_FragData[0] = c_1;
}
...
#line 395
void vert_curve_std( inout appdata_full v ) {
    #line 397
...
void main ()
{
  highp vec4 VertScreenSpace_1;
  highp vec4 tmpvar_2;
  tmpvar_2 = (glstate_matrix_modelview0 * _glesVertex);
  VertScreenSpace_1.xyw = tmpvar_2.xyw;
  VertScreenSpace_1.z = (tmpvar_2.z - ((dot (tmpvar_2.xy, tmpvar_2.xy) * _SphereCurveFactor) + _PullToCamera));
  gl_Position = (glstate_matrix_mvp * (VertScreenSpace_1 * glstate_matrix_invtrans_modelview0));
  xlv_TEXCOORD0 = ((_glesMultiTexCoord0.xy * _MainTex_ST.xy) + _MainTex_ST.zw);
...
void main ()
{
  ...
  xlv_TEXCOORD1 = tmpvar_2;
  xlv_TEXCOORD2 = tmpvar_3;
  xlv_TEXCOORD3 = (unity_World2Shadow[0] * (_Object2World * tmpvar_6));
}
...
void main ()
{
  ...
  tmpvar_5 = tmpvar_10;
  lowp vec4 c_11;
  c_11.xyz = ((c_2.xyz * _LightColor0.xyz) * ((max (0.0, dot (xlv_TEXCOORD1, _WorldSpaceLightPos0.xyz)) * tmpvar_5) * 2.0));
  c_11.w = c_2.w;
  c_1.w = c_11.w;
  c_1.xyz = (c_11.xyz + (c_2.xyz * xlv_TEXCOORD2));
  c_1.xyz = (c_1.xyz + (c_2.xyz * tmpvar_3.w));
  gl_FragData[0] = c_1;
}
...
void main ()
{
  ...
  VertScreenSpace_1.z = (tmpvar_2.z - ((dot (tmpvar_2.xy, tmpvar_2.xy) * _SphereCurveFactor) + _PullToCamera));
  highp vec4 tmpvar_3;
  tmpvar_3 = (VertScreenSpace_1 * glstate_matrix_invtrans_modelview0);
...
void main ()
{
  ...
  shadow_5 = tmpvar_7;
  lowp vec4 c_8;
  c_8.xyz = ((c_2.xyz * _LightColor0.xyz) * ((max (0.0, dot (xlv_TEXCOORD1, _WorldSpaceLightPos0.xyz)) * shadow_5) * 2.0));
  c_8.w = c_2.w;
  c_1.w = c_8.w;
  c_1.xyz = (c_8.xyz + (c_2.xyz * xlv_TEXCOORD2));
  c_1.xyz = (c_1.xyz + (c_2.xyz * tmpvar_3.w));
  gl_FragData[0] = c_1;
}
...
void main ()
{
  ...
  VertScreenSpace_2.z = (tmpvar_3.z - ((dot (tmpvar_3.xy, tmpvar_3.xy) * _SphereCurveFactor) + _PullToCamera));
  highp vec4 tmpvar_4;
  tmpvar_4 = (VertScreenSpace_2 * glstate_matrix_invtrans_modelview0);
  highp vec4 tmpvar_5;
  ...
  o_6.zw = tmpvar_5.zw;
  tmpvar_1.xyz = (((_Object2World * tmpvar_4).xyz - unity_ShadowFadeCenterAndType.xyz) * unity_ShadowFadeCenterAndType.w);
  tmpvar_1.w = (-((glstate_matrix_modelview0 * tmpvar_4).z) * (1.0 - unity_ShadowFadeCenterAndType.w));
...
void main ()
{
  ...
  VertScreenSpace_1.z = (tmpvar_2.z - ((dot (tmpvar_2.xy, tmpvar_2.xy) * _SphereCurveFactor) + _PullToCamera));
  highp vec4 tmpvar_3;
  tmpvar_3 = (glstate_matrix_mvp * (VertScreenSpace_1 * glstate_matrix_invtrans_modelview0));
  highp vec4 o_4;
  highp vec4 tmpvar_5;
