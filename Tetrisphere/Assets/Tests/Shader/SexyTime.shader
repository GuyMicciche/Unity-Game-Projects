...
void main ()
{
  ...
  gl_Position = (glstate_matrix_projection * VertScreenSpace_1);
...
v2f vert( in appdata_base v ) {
    ...
    o.pos = (glstate_matrix_projection * VertScreenSpace);
...
mediump vec4 frag( in v2f i ) {
    return (texture( _MainTex, i.uv) * _Color);
}
